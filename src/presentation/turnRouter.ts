...
const findLatestGameTurnByTurnUseCase = new FindLatestGameTurnByTurnCountUseCase(
...
turnRouter.get(
    ...
    async (req, res: express.Response<TurnGetResponseBody>) => {
        ...
        const output = await findLatestGameTurnByTurnUseCase.run(turnCount)
...
turnRouter.post(
    ...
    async (req: express.Request<{}, {}, TurnPostRequestBody>, res) => {
        ...
        await registerTurnUseCase.run(
            turnCount, disc, point
        )
